...
public class HistoryLogRepository extends RepositoryBase<HistoryLog> implements IHistoryLogRepository {
    ...
    protected String insertSql() {
        return "INSERT INTO historyLog(dateOfTransaction,amount,customer,event) VALUES(?,?,?,?)";
    }


    @Override
    protected String updateSql() {
        return "UPDATE historyLog set dateOfTransaction=?, amount=?, customer=?, event=? WHERE id=?";
    }
